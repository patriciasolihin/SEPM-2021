    ...
    <script>
        function initMap() {
            ...
            var infoWindow10 = new google.maps.InfoWindow({
                content: '<h3>Fitzroy Respiratory Clinic (Victorian Aboriginal Health Service)</h3><h4>186 Nicholson St, Fitzroy VIC 3065</h4>'
            });
            infoWindows.push(infoWindow10);

            var infoWindow11 = new google.maps.InfoWindow({
                content: '<h3>Cohealth -Collingwood</h3><h4>365 Hoddle St, Collingwood VIC 3066</h4>'
            });
            infoWindows.push(infoWindow11);

            var infoWindow12 = new google.maps.InfoWindow({
                content: '<h3>The Royal Melbourne Hospital</h3><h4>300 Grattan St, Parkville VIC 3050</h4>'
            });
            infoWindows.push(infoWindow12);

            var infoWindow13 = new google.maps.InfoWindow({
                content: '<h3>The Royal Childrens Hospital</h3><h4>50 Flemington Rd, Parkville VIC 3052</h4>'
            });
            infoWindows.push(infoWindow13);

            var infoWindow14 = new google.maps.InfoWindow({
                content: '<h3>Melbourne Pathology - North Melbourne</h3><h4>70 Alfred St, North Melbourne VIC 3051</h4>'
            });
            infoWindows.push(infoWindow14);

            var infoWindow15 = new google.maps.InfoWindow({
                content: '<h3>4Cyte Pathology - Fairfield</h3><h4>202 Station St, Fairfield VIC 3078</h4>'
            });
            infoWindows.push(infoWindow15);

            var infoWindow16 = new google.maps.InfoWindow({
                content: '<h3>Melbourne Pathology - Moonee Ponds</h3><h4>MedicalOne, 14 Pascoe Vale Road VIC 3039</h4>'
            });
            infoWindows.push(infoWindow16);

            var infoWindow17 = new google.maps.InfoWindow({
                content: '<h3>Melbourne Showgrounds</h3><h4>Epsom Rd, Ascot Vale VIC 3032</h4>'
            });
            infoWindows.push(infoWindow17);

            var infoWindow18 = new google.maps.InfoWindow({
                content: '<h3>Hampstead Road</h3><h4>5/44 Hampstead Rd, Maidstone VIC 3012</h4>'
            });
            infoWindows.push(infoWindow18);

            var infoWindow19 = new google.maps.InfoWindow({
                content: '<h3>Cohealth - West Footscray</h3><h4>CoHealth Footscray, 78 Paisley Street, Footscray VIC 3011</h4>'
            });
            infoWindows.push(infoWindow19);

            var infoWindow20 = new google.maps.InfoWindow({
                content: '<h3>Altona North Respiratory Clinic</h3><h4>230 BLACKSHAWS RD, ALTONA NORTH VIC 3025</h4>'
            });
